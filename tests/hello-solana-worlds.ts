...
import { HelloSolanaWorlds } from "../target/types/hello_solana_worlds";

describe("hello-solana-worlds", () => {
  ...
  const program = anchor.workspace.HelloSolanaWorlds as Program<HelloSolanaWorlds>;
